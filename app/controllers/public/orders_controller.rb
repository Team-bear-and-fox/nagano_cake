class Public::OrdersController < ApplicationController
  ...
  def confirm
    ...
    @cart_items.each do |cart_item|
      preces << cart_item.item.value*cart_item.amount
    end
    ...
    when "customer_address"
      @selected_address = current_customer.postal_code + "　" + current_customer.address + "　" + curremt_customer.last_name + "　" + current_customer.first_name
